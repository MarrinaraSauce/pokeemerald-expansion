...
// Regional Forms
enum RegionalFormsDex
{
    REGIONAL_FORM_DEX_NONE,
    REGIONAL_FORM_DEX_RATTATA_ALOLA,
    REGIONAL_FORM_DEX_RATICATE_ALOLA,
    REGIONAL_FORM_DEX_RAICHU_ALOLA,
    REGIONAL_FORM_DEX_SANDSHREW_ALOLA,
    REGIONAL_FORM_DEX_SANDSLASH_ALOLA,
    REGIONAL_FORM_DEX_VULPIX_ALOLA,
    REGIONAL_FORM_DEX_NINETALES_ALOLA,
    REGIONAL_FORM_DEX_DIGLETT_ALOLA,
    REGIONAL_FORM_DEX_DUGTRIO_ALOLA,
    REGIONAL_FORM_DEX_MEOWTH_ALOLA,
    REGIONAL_FORM_DEX_MEOWTH_GALAR,
    REGIONAL_FORM_DEX_PERSIAN_ALOLA,
    REGIONAL_FORM_DEX_GROWLITHE_HISUI,
    REGIONAL_FORM_DEX_ARCANINE_HISUI,
    REGIONAL_FORM_DEX_GEODUDE_ALOLA,
    REGIONAL_FORM_DEX_GRAVELER_ALOLA,
    REGIONAL_FORM_DEX_GOLEM_ALOLA,
    REGIONAL_FORM_DEX_PONYTA_GALAR,
    REGIONAL_FORM_DEX_RAPIDASH_GALAR,
    REGIONAL_FORM_DEX_SLOWPOKE_GALAR,
    REGIONAL_FORM_DEX_SLOWBRO_GALAR,
    REGIONAL_FORM_DEX_SLOWKING_GALAR,
    REGIONAL_FORM_DEX_FARFETCHD_GALAR,
    REGIONAL_FORM_DEX_GRIMER_ALOLA,
    REGIONAL_FORM_DEX_MUK_ALOLA,
    REGIONAL_FORM_DEX_VOLTORB_HISUI,
    REGIONAL_FORM_DEX_ELECTRODE_HISUI,
    REGIONAL_FORM_DEX_EXEGGUTOR_ALOLA,
    REGIONAL_FORM_DEX_MAROWAK_ALOLA,
    REGIONAL_FORM_DEX_WEEZING_GALAR,
    REGIONAL_FORM_DEX_MR_MIME_GALAR,
    REGIONAL_FORM_DEX_TAUROS_PALDEA_COMBAT,
    REGIONAL_FORM_DEX_TAUROS_PALDEA_BLAZE,
    REGIONAL_FORM_DEX_TAUROS_PALDEA_AQUA,
    REGIONAL_FORM_DEX_ARTICUNO_GALAR,
    REGIONAL_FORM_DEX_ZAPDOS_GALAR,
    REGIONAL_FORM_DEX_MOLTRES_GALAR,
    REGIONAL_FORM_DEX_TYPHLOSION_HISUI,
    REGIONAL_FORM_DEX_WOOPER_PALDEA,
    REGIONAL_FORM_DEX_QWILFISH_HISUI,
    REGIONAL_FORM_DEX_SNEASEL_HISUI,
    REGIONAL_FORM_DEX_CORSOLA_GALAR,
    REGIONAL_FORM_DEX_ZIGZAGOON_GALAR,
    REGIONAL_FORM_DEX_LINOONE_GALAR,
};
//Change this def if you add more regions
#define REGIONAL_FORM_DEX_COUNT REGIONAL_FORM_DEX_LINOONE_GALAR

#define POKEMON_SLOTS_NUMBER (NATIONAL_DEX_COUNT + REGIONAL_FORM_DEX_COUNT + 1)
